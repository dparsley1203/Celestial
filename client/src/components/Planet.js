...
export const Planet = ({planet}) => {
    ...
    if (planet.planetTypeId === 1 && planet.diameter <= 7000 && planet.colorId === 1) {
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 1) {
        imgtype = <img src={RedGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 2) {
        imgtype = <img src={YellowGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 3) {
        imgtype = <img src={BlueGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 4) {
        imgtype = <img src={OrangeGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 5) {
        imgtype = <img src={PurpleGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 2 && planet.diameter >= 10001 && planet.colorId === 6) {
        imgtype = <img src={GreenGiant} width="275" height="275" />
    ...
    } else if (planet.planetTypeId === 3 && planet.diameter >= 10001 && planet.colorId === 1) {
        imgtype = <img src={RedIce} width="250" height="250" />
    ...
    } else if (planet.planetTypeId === 3 && planet.diameter >= 10001 && planet.colorId === 2) {
        imgtype = <img src={YellowIce} width="250" height="250" />
    ...
    } else if (planet.planetTypeId === 3 && planet.diameter >= 10001 && planet.colorId === 3) {
        imgtype = <img src={BlueIce} width="250" height="250" />
    ...
    } else if (planet.planetTypeId === 3 && planet.diameter >= 10001 && planet.colorId === 4) {
        imgtype = <img src={OrangeIce} width="250" height="250" />
    ...
    } else if (planet.planetTypeId === 3 && planet.diameter >= 10001 && planet.colorId === 5) {
        imgtype = <img src={PurpleIce} width="250" height="250" />
        ...
        imgtype = <img src={GreenIce} width="250" height="250" />
